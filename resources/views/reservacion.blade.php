                ...
                <div class="col-md-4">
                    <div class="row border border-secondary rounded-lg shadow">
                        <div class="form-group col-12 mt-3">
                            ...
                            <select v-if="p != ''" class="form-control" name="" id="paquete_edit"  @change="getPaquete" v-model="reservacion.paquete">
                            ...
                            <div v-if="paquete_sel != ''" class="container border border-secondary rounded shadow">
